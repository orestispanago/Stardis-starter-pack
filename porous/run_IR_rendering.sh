...
#launch Stardis
stardis -V 3 -a 680 -r 800 -M porous.txt -R spp=${SPP}:img=${WIDTH}x${HEIGHT}:fov=30:pos=${POSITION}:tgt=${TARGET}:up=0,0,1 > ${FILE}.ht


#convert ht file in ppm file 
htpp -f -o  ${FILE}.ppm -v -m default:range=650,850 ${FILE}.ht
